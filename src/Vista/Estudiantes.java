...
public class Estudiantes extends javax.swing.JFrame {
    ...
    public void listarEstudiantes() {
        List<Estudiante> listarES = estudiante.ListarEstudiante();
        modelo = (DefaultTableModel) tableEstudiante.getModel();
        Object[] ob = new Object[6];
        for (int i = 0; i < listarES.size(); i++) {
            ob[0] = listarES.get(i).getEstudianteID();
            ob[1] = listarES.get(i).getDni();
            ob[2] = listarES.get(i).getNombre();
            ob[3] = listarES.get(i).getApellido();
            ob[4] = listarES.get(i).getEdad();
            ob[5] = listarES.get(i).getDireccion();
            modelo.addRow(ob);
        }
    ...
    private void initComponents() {
        ...
        favicon.setText("Panel de Estudiantes");
        ...
        iddocente.setText("ID Estudiante");
        ...
        bg.add(txtIdEstudiante, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 130, 270, 30));
        ...
        if (tableEstudiante.getColumnModel().getColumnCount() > 0) {
            tableEstudiante.getColumnModel().getColumn(0).setPreferredWidth(80);
            tableEstudiante.getColumnModel().getColumn(0).setMaxWidth(80);
            tableEstudiante.getColumnModel().getColumn(1).setPreferredWidth(80);
            tableEstudiante.getColumnModel().getColumn(1).setMaxWidth(80);
            tableEstudiante.getColumnModel().getColumn(2).setPreferredWidth(130);
            tableEstudiante.getColumnModel().getColumn(2).setMaxWidth(130);
            tableEstudiante.getColumnModel().getColumn(3).setPreferredWidth(130);
            tableEstudiante.getColumnModel().getColumn(3).setMaxWidth(130);
            tableEstudiante.getColumnModel().getColumn(4).setPreferredWidth(60);
            tableEstudiante.getColumnModel().getColumn(4).setMaxWidth(60);
        }
    ...
    private void agregarBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_agregarBtnTxtMouseClicked
        ...
        es.setEstudianteID(generarID(Integer.parseInt(txtIdEstudiante.getText())));
        ...
        limpiarCampos();
        listarEstudiantes();
        JOptionPane.showMessageDialog(this, "Estudiante Registrado con Éxito ", "REGISTRO EXITOSO", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void buscarBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buscarBtnTxtMouseClicked
        if ("".equals(txtIdEstudiante.getText()) || "Ingrese el ID".equals(txtIdEstudiante.getText()) || null == (txtIdEstudiante.getText())) {
            String id = JOptionPane.showInputDialog(null, "Ingrese el ID del estudiante a buscar", "BUSCAR ESTUDIANTE", JOptionPane.INFORMATION_MESSAGE);
            if (id != null) {
                JOptionPane.showMessageDialog(null, (estudiante.BuscarEstudiante(id)), ("DATOS DEL ESTUDIANTE " + id), JOptionPane.INFORMATION_MESSAGE);
                limpiarTabla();
                limpiarCampos();
                listarEstudiantes();
            }
    ...
    private void deleteBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteBtnTxtMouseClicked
        if ("".equals(txtIdEstudiante.getText()) || "Ingrese el ID".equals(txtIdEstudiante.getText()) || null == txtIdEstudiante) {
            String id = JOptionPane.showInputDialog(null, "Ingrese el ID del estudiante a eliminar", "ELIMINAR ESTUDIANTE", JOptionPane.INFORMATION_MESSAGE);
            if (id != null) {
                int confirmation = JOptionPane.showConfirmDialog(null, ("¿Estas seguro de eliminar al estudiante " + id + " ?"), "ELIMINAR ESTUDIANTE", JOptionPane.YES_NO_OPTION);
                if (confirmation == 0) {
                    estudiante.EliminarEstudiante(id);
                    limpiarTabla();
                    limpiarCampos();
                    listarEstudiantes();
                    JOptionPane.showMessageDialog(this, "Estudiante Eliminado con Éxito ", "ELIMINACIÓN EXITOSA", JOptionPane.INFORMATION_MESSAGE);
                }
            }
            return;
        }
    ...
    private void updateBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateBtnTxtMouseClicked
        ...
        es.setEdad(Integer.parseInt(txtEdad.getText()));
        es.setDireccion(txtDireccion.getText());
        int confirmation = JOptionPane.showConfirmDialog(null, ("¿Estas seguro de actualizar al estudiante " + es.getEstudianteID() + " ?"), "ACTUALIZAR ESTUDIANTE", JOptionPane.YES_NO_OPTION);
        if (confirmation == 0) {
            estudiante.ModificarEstudiante(es);
            limpiarTabla();
            limpiarCampos();
            listarEstudiantes();
            JOptionPane.showMessageDialog(this, "Estudiante Actualizado con Éxito ", "ACTUALIZACIÓN EXITOSA", JOptionPane.INFORMATION_MESSAGE);
        }
