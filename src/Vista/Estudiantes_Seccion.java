...
public class Estudiantes_Seccion extends javax.swing.JFrame {
    ...
    public Estudiantes_Seccion() {
        initComponents();
        this.setLocationRelativeTo(null);
        listarEstudiantesSeccion();
    }

    public void listarEstudiantesSeccion() {
        List<EstudianteSeccion> listarESSC = estudiante_seccion.ListarEstudianteSeccion();
        modelo = (DefaultTableModel) tableEstudianteSeccion.getModel();
        Object[] ob = new Object[4];
        for (int i = 0; i < listarESSC.size(); i++) {
            ob[0] = listarESSC.get(i).getEstudianteID();
            ob[1] = estudiante_seccion.buscarNombreEstudiante(listarESSC.get(i).getSeccionID(), listarESSC.get(i).getEstudianteID());
            ob[2] = listarESSC.get(i).getSeccionID();
            ob[3] = estudiante_seccion.buscarNombreSeccion(listarESSC.get(i).getSeccionID(), listarESSC.get(i).getEstudianteID());
            modelo.addRow(ob);
        }
        tableEstudianteSeccion.setModel(modelo);
    }
    ...
    public void limpiarCampos() {
        txtIdEstudiante.setText("Ingrese el ID");
    ...
    public String generarIDEstudiante(int id) {
    ...
    private void initComponents() {
        ...
        tableEstudianteSeccion = new javax.swing.JTable();
        ...
        favicon.setText("Panel de Estudiantes por Sección");
        ...
        txtIdEstudiante.setFont(new java.awt.Font("Roboto", 0, 10)); // NOI18N
        txtIdEstudiante.setForeground(new java.awt.Color(204, 204, 204));
        txtIdEstudiante.setText("Ingrese el ID");
        txtIdEstudiante.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        txtIdEstudiante.setCaretColor(new java.awt.Color(0, 51, 204));
        txtIdEstudiante.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                txtIdEstudianteMousePressed(evt);
            }
        });
        ...
        bg.add(txtIdEstudiante, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 200, 270, 30));
        ...
        nombrelbl.setText("ID Estudiante");
        ...
        tableEstudianteSeccion.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID ESTUDIANTE", "NOMBRE ESTUDIANTE", "ID SECCION", "NOMBRE SECCION"
            }
        ));
        jScrollPane1.setViewportView(tableEstudianteSeccion);
    ...
    private void txtIdEstudianteMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtIdEstudianteMousePressed
        if (txtIdEstudiante.getText().equals("Ingrese el ID")) {
            txtIdEstudiante.setText("");
            txtIdEstudiante.setForeground(Color.black);
        }
    }//GEN-LAST:event_txtIdEstudianteMousePressed
    ...
    private void agregarBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_agregarBtnTxtMouseClicked
        ...
        if ("".equals(txtIdEstudiante.getText()) || "Ingrese el ID".equals(txtIdEstudiante.getText())) {
            JOptionPane.showMessageDialog(null, "Porfavor Ingrese un ID de estudiante", "CAMPO INCOMPLETO", JOptionPane.WARNING_MESSAGE);
            return;
        }
        es_sc.setSeccionID(generarIDSeccion(Integer.parseInt(txtIdSeccion.getText())));
        es_sc.setEstudianteID(generarIDEstudiante(Integer.parseInt(txtIdEstudiante.getText())));
        estudiante_seccion.RegistrarEstudianteSeccion(es_sc);
        limpiarTabla();
        limpiarCampos();
        listarEstudiantesSeccion();
        JOptionPane.showMessageDialog(this, "Estudiante Registrado con Éxito en la Sección", "REGISTRO EXITOSO", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void buscarBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buscarBtnTxtMouseClicked
        if ("".equals(txtIdSeccion.getText()) || "Ingrese el ID".equals(txtIdSeccion.getText()) || null == (txtIdSeccion.getText())) {
            if ("".equals(txtIdEstudiante.getText()) || "Ingrese el ID".equals(txtIdEstudiante.getText()) || null == (txtIdEstudiante.getText())) {
                String idSeccion = JOptionPane.showInputDialog(null, "Ingrese el ID de la sección a buscar", "BUSCAR ESTUDIANTE X SECCIÓN", JOptionPane.INFORMATION_MESSAGE);
                String idEstudiante = JOptionPane.showInputDialog(null, "Ingrese el ID del estudiante a buscar", "BUSCAR ESTUDIANTE X SECCIÓN", JOptionPane.INFORMATION_MESSAGE);
                if (idSeccion != null && idEstudiante != null) {
                    JOptionPane.showMessageDialog(null, (estudiante_seccion.BuscarEstudianteSeccion(idSeccion, idEstudiante)), ("DATOS DEL ESTUDIANTE X LA SECCIÓN"), JOptionPane.INFORMATION_MESSAGE);
                    limpiarTabla();
                    limpiarCampos();
                    listarEstudiantesSeccion();
                }
    ...
    private void updateBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateBtnTxtMouseClicked
        ...
        es_sc.setSeccionID(generarIDSeccion(Integer.parseInt(txtIdSeccion.getText())));
        es_sc.setEstudianteID(generarIDEstudiante(Integer.parseInt(txtIdEstudiante.getText())));
        int confirmation = JOptionPane.showConfirmDialog(null, ("¿Estas seguro de actualizar la sección del estudiante " + es_sc.getEstudianteID() + " ?"), "ACTUALIZAR ESTUDIANTE X SECCIÓN", JOptionPane.YES_NO_OPTION);
        if (confirmation == 0) {
            String idSeccion = JOptionPane.showInputDialog(null, "Ingrese el nuevo ID de la sección", "ACTUALIZAR ESTUDIANTE X SECCIÓN", JOptionPane.INFORMATION_MESSAGE);
            if (idSeccion != null) {
                estudiante_seccion.ModificarEstudianteSeccion(es_sc, idSeccion);
                limpiarTabla();
                limpiarCampos();
                listarEstudiantesSeccion();
                JOptionPane.showMessageDialog(this, "Sección del Estudiante Actualizada con Éxito", "ACTUALIZACIÓN EXITOSA", JOptionPane.INFORMATION_MESSAGE);
            }
        }
    ...
    private void deleteBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteBtnTxtMouseClicked
        if ("".equals(txtIdSeccion.getText()) || "Ingrese el ID".equals(txtIdSeccion.getText()) || null == (txtIdSeccion.getText())) {
            if ("".equals(txtIdEstudiante.getText()) || "Ingrese el ID".equals(txtIdEstudiante.getText()) || null == (txtIdEstudiante.getText())) {
                String idSeccion = JOptionPane.showInputDialog(null, "Ingrese el ID de la sección a eliminar", "ELIMINAR ESTUDIANTE X SECCIÓN", JOptionPane.INFORMATION_MESSAGE);
                String idEstudiante = JOptionPane.showInputDialog(null, "Ingrese el ID del estudiante a eliminar", "ELIMINAR ESTUDIANTE X SECCIÓN", JOptionPane.INFORMATION_MESSAGE);
                if (idSeccion != null && idEstudiante != null) {
                    int confirmation = JOptionPane.showConfirmDialog(null, ("¿Estas seguro de eliminar al estudiante de la sección " + idSeccion + " ?"), "ELIMINAR ESTUDIANTE X SECCIÓN", JOptionPane.YES_NO_OPTION);
                    if (confirmation == 0) {
                        estudiante_seccion.EliminarEstudianteSeccion(idSeccion, idEstudiante);
                        limpiarTabla();
                        limpiarCampos();
                        listarEstudiantesSeccion();
                        JOptionPane.showMessageDialog(this, "Estudiante Eliminado con Éxito de la Sección", "ELIMINACIÓN EXITOSA", JOptionPane.INFORMATION_MESSAGE);
                    }
                }
                return;
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Estudiantes_Seccion.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Estudiantes_Seccion().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tableEstudianteSeccion;
