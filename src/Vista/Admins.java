...
public class Admins extends javax.swing.JFrame {
    ...
    public void listarAdmins() {
        List<Admin> listarAD = admin.ListarAdmin();
        modelo = (DefaultTableModel) tableAdmin.getModel();
        Object[] ob = new Object[4];
        for (int i = 0; i < listarAD.size(); i++) {
            ob[0] = listarAD.get(i).getAdminID();
            ob[1] = listarAD.get(i).getCorreo();
            ob[2] = listarAD.get(i).getPass();
            modelo.addRow(ob);
        }
    ...
    private void initComponents() {
        ...
        favicon.setText("Panel de Administradores");
        ...
        bg.add(txtCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 200, 270, 30));
        ...
        txtIdAdmin.setFont(new java.awt.Font("Roboto", 0, 10)); // NOI18N
        ...
        txtIdAdmin.setCaretColor(new java.awt.Color(0, 51, 204));
        ...
        bg.add(txtIdAdmin, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 130, 270, 30));
        ...
        bg.add(txtPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 270, 270, 30));
    ...
    private void txtCorreoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtCorreoMousePressed
        if (txtCorreo.getText().equals("Ingrese el DNI")) {
            txtCorreo.setText("");
    ...
    private void agregarBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_agregarBtnTxtMouseClicked
        if ("".equals(txtIdAdmin.getText()) || "Ingrese el ID".equals(txtIdAdmin.getText())) {
            JOptionPane.showMessageDialog(null, "Porfavor Ingrese un ID", "CAMPO INCOMPLETO", JOptionPane.WARNING_MESSAGE);
            return;
        }
        if ("".equals(txtPass.getText()) || "Ingrese la contraseña".equals(txtPass.getText())) {
            JOptionPane.showMessageDialog(null, "Porfavor Ingrese una contraseña", "CAMPO INCOMPLETO", JOptionPane.WARNING_MESSAGE);
            return;
        }
        if ("".equals(txtCorreo.getText()) || "Ingrese el correo".equals(txtCorreo.getText())) {
            JOptionPane.showMessageDialog(null, "Porfavor Ingrese un correo", "CAMPO INCOMPLETO", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ad.setAdminID(generarID(Integer.parseInt(txtIdAdmin.getText())));
        ad.setCorreo(txtCorreo.getText());
        ad.setPass(txtPass.getText());
        admin.RegistrarAdmin(ad);
        limpiarTabla();
        limpiarCampos();
        listarAdmins();
        JOptionPane.showMessageDialog(this, "Admin Registrado con Éxito ", "REGISTRO EXITOSO", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void buscarBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buscarBtnTxtMouseClicked
        if ("".equals(txtIdAdmin.getText()) || "Ingrese el ID".equals(txtIdAdmin.getText()) || null == (txtIdAdmin.getText())) {
            String id = JOptionPane.showInputDialog(null, "Ingrese el ID del admin a buscar", "BUSCAR ADMIN", JOptionPane.INFORMATION_MESSAGE);
            if (id != null) {
                JOptionPane.showMessageDialog(null, (admin.BuscarAdmin(id)), ("DATOS DEL ADMINISTRADOR " + id), JOptionPane.INFORMATION_MESSAGE);
                limpiarTabla();
                limpiarCampos();
                listarAdmins();
            }
    ...
    private void deleteBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteBtnTxtMouseClicked
        if ("".equals(txtIdAdmin.getText()) || "Ingrese el ID".equals(txtIdAdmin.getText()) || null == txtIdAdmin) {
            String id = JOptionPane.showInputDialog(null, "Ingrese el ID del admin a eliminar", "ELIMINAR ADMIN", JOptionPane.INFORMATION_MESSAGE);
            if (id != null) {
                int confirmation = JOptionPane.showConfirmDialog(null, ("¿Estas seguro de eliminar al administrador " + id + " ?"), "ELIMINAR ADMINISTRADOR", JOptionPane.YES_NO_OPTION);
                if (confirmation == 0) {
                    admin.EliminarAdmin(id);
                    limpiarTabla();
                    limpiarCampos();
                    listarAdmins();
                    JOptionPane.showMessageDialog(this, "Administrador Eliminado con Éxito ", "ELIMINACIÓN EXITOSA", JOptionPane.INFORMATION_MESSAGE);
                }
            }
            return;
        }
    ...
    private void updateBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateBtnTxtMouseClicked
        ...
        ad.setCorreo(txtCorreo.getText());
        ad.setPass(txtPass.getText());
        int confirmation = JOptionPane.showConfirmDialog(null, ("¿Estas seguro de actualizar al administrador " + ad.getAdminID() + " ?"), "ACTUALIZAR ADMINISTRADOR", JOptionPane.YES_NO_OPTION);
        if (confirmation == 0) {
            admin.ModificarAdmin(ad);
            limpiarTabla();
            limpiarCampos();
            listarAdmins();
            JOptionPane.showMessageDialog(this, "Administrador Actualizado con Éxito ", "ACTUALIZACIÓN EXITOSA", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    private void txtPassMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtPassMousePressed
        if (txtPass.getText().equals("Ingrese el nombre")) {
            txtPass.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admins.class
